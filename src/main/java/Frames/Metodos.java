...
import com.mycompany.analizadorsintactico.Funcion;
...
public class Metodos extends javax.swing.JFrame {
    ...
    public Metodos(FramePrincipal frame) {
        modelReporte = new DefaultTableModel();
        this.frame = frame;
        initComponents();
        crearModelo();
        llenarDatos(this.frame.getSin().getFunciones());
    }
    ...
    private void llenarDatos(ArrayList<Funcion> funciones){
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(70, 130, 169));
